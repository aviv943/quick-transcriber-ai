...
### Manual Docker Run
```bash
docker run -d -p 3000:80 aviv943/quick-transcriber-ai:latest
```

The Docker image is automatically built and published via GitHub Actions on every push to main.
